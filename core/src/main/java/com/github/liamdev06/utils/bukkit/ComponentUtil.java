...
/**
 * Utility class for working with {@link Component}.
 */
@UtilityClass
public class ComponentUtil {
    ...
    public static @NonNull String toString(@Nullable Component component) {
        ...
        return PlayerMessenger.MINI_MESSAGE.serialize(component);
    }
